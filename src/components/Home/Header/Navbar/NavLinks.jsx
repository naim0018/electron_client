...
const NavLinks = () => {
    ...
    const [isNestedDropdown5Open, setNestedDropdown5Open] = useState(false);
    return (
        <div className='lg:flex list-none font-poppins max-w-7xl  xl:text-base lg:text-[.9rem] hidden font-medium xl:gap-x-12 gap-x-5 text-white'>
            {/* home */}
